...
$sportsNews = $user->getSportsNewsPaginationEn($start_from, $num_per_page);

$sportsNewsAry = array();

foreach ($sportsNews as $key => $value) {
    $place =array(
        "id" => trim($value['id']," "),
...
$finalAry =  json_encode($sportsNewsAry);
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle active" id="pagesMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Category</a>
							<ul class='dropdown-menu' aria-labelledby='pagesMenu'>
								...
								<li><a class='dropdown-item active' href="sports_en.php"> Sports </a></li>
...
<section class="pt-4">
	<div class="container">
		<div class="row">
      <div class="col-12">
        <div class="card bg-dark-overlay-4 overflow-hidden card-bg-scale h-300 text-center" style="background-image:url('img/sportscover.jpg'); background-position: center left; background-size: cover;">
          <!-- Card Image overlay -->
            ...
            <div class="w-100 my-auto">
              ...
              <h1 class="text-white h2">
								<span class="badge bg-warning mb-2">
									<i class="fas fa-circle me-2 small fw-bold"></i>Sports</span>
							</h1>
              <div class="text-center position-relative">
              	<?php 			   	 		
              			$newsCount = $user->getSportsNewsCountEn();	
	...
	<div class="container" data-sticky-container>
		<div class="row">
            ...
            <div class="row filter-container overflow-hidden" data-isotope='{"layoutMode": "masonry"}'>
               <!-- Card item START -->	
               <?php foreach ($sportsNewsAry as $singleTitle):  
               			// print_r($singleTitle);
               	?>	
			...
			<nav class="mt-5" aria-label="navigation">
	                ...
	                {	    	                     	          
				        		...
				        		echo "<li class='page-item flex-fill text-center'> <a href='sports_en.php?page=".($page-1)."' class='page-link'> <i class='fas fa-long-arrow-alt-left me-2 rtl-flip'></i> Previous</a>	</li>"; 
				        			 				        				
	                }
	            		elseif($page < $total_page) {                	
			        			echo "<li class='page-item flex-fill text-center'> <a href='sports_en.php?page=".($page+1)."' class='page-link'>	Next <i class='fas fa-long-arrow-alt-right ms-2 rtl-flip'>
			        			</i></a></li>"; 
			        	}
			      ?>			   	 

...
<html lang="en">
<head>
	<title>Terms & Condition - HtooMedia</title>
...
<body>
	<div class="container">
		...
		<ul>
			...
			<li>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Htoo Media.</li>
			...
			<li>Website refers to Htoo Media, accessible from www.htoomedia.info</li>	
		...
		<ul><li>By email: arata.ethereal@gmail.com</li></ul>
